-- Script de création des tables pour l'application Gestion RH
-- Les tables seront créées automatiquement par Hibernate au déploiement
-- Ce script est fourni pour référence ou création manuelle
...
-- Ajouter la clé étrangère pour le responsable du département
