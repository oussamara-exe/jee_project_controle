...
-- Insertion des comptes utilisateurs (mot de passe: "password123" hashé avec BCrypt)
-- Note: En production, utiliser BCrypt avec un salt approprié
...
-- Insertion des soldes de congés pour l'année en cours
...
-- Insertion de quelques demandes de congés de test
...
-- Insertion d'actions historiques
...
-- Username: rh.manager     | Password: password123 | Rôle: RH
-- Username: it.manager     | Password: password123 | Rôle: MANAGER
-- Username: dev.senior     | Password: password123 | Rôle: EMPLOYE
-- Username: dev.junior     | Password: password123 | Rôle: EMPLOYE
