...
<jsp:include page="../../fragments/header.jsp">
    <jsp:param name="pageTitle" value="Tableau de bord RH" />
</jsp:include>
...
<div class="col-md-10">
    <div class="content-wrapper">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h1><i class="fas fa-tachometer-alt"></i> Tableau de bord - Ressources Humaines</h1>
        ...
        <div class="alert alert-info" role="alert">
            ...
            <p class="mb-0">Vous êtes connecté en tant que <strong>Responsable RH</strong>.</p>
        </div>
            ...
            <div class="col-md-3 mb-4">
                <div class="card text-white" style="background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%);">
                    <div class="card-body">
                        ...
                        <small>En attente de validation RH</small>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-3 mb-4">
                <div class="card text-white" style="background: linear-gradient(135deg, #fa709a 0%, #fee140 100%);">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <h6 class="card-title mb-2">Fiches de paie</h6>
                                <h2 class="mb-0"><i class="fas fa-file-invoice-dollar"></i></h2>
                            </div>
                            <div>
                            ...
                            <div class="col-md-3 mb-3">
                                <a href="${pageContext.request.contextPath}/app/conges/validation" 
                                   class="btn btn-info w-100 py-3">
                                    ...
                                    Valider congés
                                    <c:if test="${congesEnAttenteRH > 0}">
                                        <span class="badge bg-danger">${congesEnAttenteRH}</span>
                                    </c:if>
                                </a>
                            </div>
                            <div class="col-md-3 mb-3">
                                <a href="${pageContext.request.contextPath}/app/paie/list" 
                                   class="btn btn-warning w-100 py-3">
                                    <i class="fas fa-money-check-alt fa-2x d-block mb-2"></i>
                                    Gérer la paie
                                </a>
                            </div>
                            <div class="col-md-3 mb-3">
